(function () {
  ...
  entervrButton.addEventListener('click', function () {
    ...
    if (inVR) {
	  entervrButton.setAttribute("class", "active")
      if (display.capabilities.canPresent) {
	  ...
	  entervrButton.setAttribute("class", "")
  ...
  function vrAnimate() {
	...
	if (curPos != null){
		gameInstance.SendMessage('WebVRCameraSet', 'SetCameraPosition', curPos.toString());
	}
	if (curOrient != null){
		gameInstance.SendMessage('WebVRCameraSet', 'SetCameraRotation', curOrient.toString());
	}
